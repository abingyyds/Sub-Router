...
export default function Login() {
  ...
  const handleOAuthLogin = (provider) => {
    ...
    const affCode = new URLSearchParams(location.search).get('aff');
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="glass rounded-2xl p-8">
          ...
          {Array.isArray(site?.oauth_providers) && site.oauth_providers.length > 0 && (
            <div className="mt-6">
              ...
              <div className="mt-4 grid gap-3">
                {site.oauth_providers.map((provider) => (
                  <button
                    key={provider.id}
                    type="button"
                  ...
                  >
                    {oauthLoadingProvider === provider.id ? (
                      <div className="h-4 w-4 rounded-full animate-spin border-2 border-page-divider" style={{ borderTopColor: 'currentColor' }} />
                    ) : (
